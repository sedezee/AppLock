...
public class DataManager implements Serializable {
    ...
    /* Both of the save.DataManager constructors are designed to
    automatically load in the specified save file. The save.DataManager
    ...
    public DataManager() {
        ...
        if (!file.mkdirs() && (file = new File(directory + SAVE_NAME)).exists()) {
            try {
                ...
                this.programs = Collections.synchronizedList(dataManager.programs);
